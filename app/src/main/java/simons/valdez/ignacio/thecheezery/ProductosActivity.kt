...
class ProductosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var listView:ListView = findViewById(R.id.listView_lista) as ListView
    ...
    fun agregarProductos(option:String?){
        when(option){
            ...
            "salties"->{
                ...
                //menu.add(Product("Panini", R.drawable.panini, "Sandwich made with Italian bread  served warmed by grilling.", 4.0))
    ...
    private class AdaptadorProductos:BaseAdapter{
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            descripcion.setText(product.description)
